...
def test(index, observe_weight=50, n_components=50):
    ...
    args.snapshot = '/mnt/jfs/zhaoxiaoyu/Gappy_POD/heat2D/logs/ckpt/mlp_heat2D_16/best_epoch_299_loss_0.00004455.pth'
    ...
    net = MLP(layers=[16, 128, 1280, 4800, 200 * 200]).cuda()
    ...
    sio.savemat('mlp_gappy.mat', {
        'true': outputs[-1, 0, :, :].cpu().numpy(),
        'pre': pre[-1, :].reshape(200, 200).cpu().numpy()
    })
...
if __name__ == '__main__':
    ...
    # observe_weight_c = [20, 50, 100, 200, 500]
    # n_components_c = [20, 30, 35, 40, 50]
    ...
    #         mae = test([i for i in range(4000, 5000)], observe_weight, n_components)
    ...
    test([i for i in range(5999, 6000)], 500, 30)
