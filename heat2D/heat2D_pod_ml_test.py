...
def ridge_regression(train_inputs, train_outputs, val_inputs, val_outputs):
    ...
    tuned_parameter = [{'alpha': [1e-8, 1e-7, 1e-6, 0.00001, 0.0001, 0.001, 0.01, 0.1, 0.5, 1.0]}]
...
if __name__ == '__main__':
    ...
    pod_index = [i for i in range(3000)]
    train_index = [i for i in range(3000)]
    val_index = [i for i in range(3000, 3500)]
    test_index = [i for i in range(5000, 6000)]
    ...
    # aug_inputs, aug_outputs = pod_cylinder.sample(200)
