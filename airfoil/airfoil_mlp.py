...
def train():
    ...
    # Build data loader
    train_dataset = AirfoilDataset(index=[i for i in range(500)], type='p', expand=4)
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, num_workers=4, shuffle=True)
    val_dataset = AirfoilDataset(index=[i for i in range(500, 700)], type='p')
...
def test(index):
    ...
    # Define data loader
    test_dataset = AirfoilDataset(index=index, type='p')
