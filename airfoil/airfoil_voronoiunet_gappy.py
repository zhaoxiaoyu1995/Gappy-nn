...
args = parses()
args.exp = 'voronoiunet_airfoil_4'
args.epochs = 300
args.batch_size = 4
print(args)
...
if __name__ == '__main__':
    ...
    test_dataset = AirfoilInterpolGappyDataset(index=[i for i in range(999, 1000)], type='vx')
    ...
    args.snapshot = '/mnt/jfs/zhaoxiaoyu/Gappy_POD/airfoil/logs/ckpt/voronoiunet_airfoil_8/best_epoch_297_loss_0.00061218.pth'
    ...
    test(net, test_loader, pod_index, 500, 10, test_dataset)
