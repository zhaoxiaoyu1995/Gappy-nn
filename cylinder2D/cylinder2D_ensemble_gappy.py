...
if __name__ == '__main__':
    ...
    test_dataset = CylinderInterpolGappyDataset(index=[i for i in range(4250, 5000)])
    test_loader = DataLoader(test_dataset, batch_size=args.batch_size, num_workers=0)

    # Path of trained network
    args.snapshot1 = '/mnt/jfs/zhaoxiaoyu/Gappy_POD/cylinder2D/logs/ckpt/voronoiunet_cylinder_2/best_epoch_296_loss_0.00023538.pth'
    args.snapshot2 = '/mnt/jfs/zhaoxiaoyu/Gappy_POD/cylinder2D/logs/ckpt/mlp_cylinder_2/best_epoch_299_loss_0.00030110.pth'
    ...
    net2 = MLP(layers=[2, 128, 1280, 4800, 21504]).cuda()
    ...
    test(net1, net2, test_loader, 100, 30)
