...
# h = ax.contourf(x_coor, y_coor, data['true'], interpolation='bilinear', cmap=cmaps.gui_default, origin='lower', aspect='auto')
h = ax.contourf(x_coor, y_coor, data['true'], cmap=cmaps.gui_default, origin='lower', levels=100)
...
h = ax.imshow(data['true'].T - data['pre'].T, interpolation='bilinear', cmap=cmaps.gui_default,
