...
def test():
    ...
    args.snapshot = '/mnt/jfs/zhaoxiaoyu/Gappy_POD/subsonicairfoil/logs/ckpt/mlp_sub_airfoil_24_p/best_epoch_298_loss_0.00137201.pth'

    # Define data loader
    positions = [2644, 4263, 2618, 9630, 11559, 7968, 14062, 15348, 16093, 8269, 13706, 11937, 15401, 14167,
                 16110, 15366, 16268, 13194, 3143, 14795, 8303, 4772, 16252, 1553, 15703, 13210, 3160, 14809,
                 2271, 1566, 658, 8314]
    ...
    net = MLP(layers=[24, 128, 1280, 4800, 16339]).cuda()
